...
class parser_args(TaskDispatcher, name='Restormer_KAv3'):
    def __init__(self, cfg=None):
        ...
        parser.add_argument('-samples_per_gpu', default=6, type=int,
        ...
        # * Model and Dataset
        parser.add_argument('--arch', '-a', metavar='ARCH', default='Restormer_KAv3', type=str)
