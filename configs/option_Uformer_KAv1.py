...
class parser_args(TaskDispatcher, name='Uformer_KAv1'):
    def __init__(self, cfg=None):
        ...
        parser.add_argument('--arch', '-a', metavar='ARCH', default='Uformer_KAv1')
        ...
        # SRData
        parser.add_argument('--model', default='Uformer_KAv1', help='model name')
...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--arch', type=str, default ='Uformer_KAv1',  help='archtechture')
