...
class parser_args(TaskDispatcher, name='Uformer_tinypaperv1'):
    def __init__(self, cfg=None):
        ...
        # model_path = r'results\derain\Rain100L\Uformer\Test\model_2023-12-02-00-35-25\3000.pth.tar'
        ...
        parser.add_argument('--arch', '-a', metavar='ARCH', default='Uformer_tinypaperv1')
...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--arch', type=str, default ='Uformer_tinypaperv1',  help='archtechture')
