...
class parser_args(TaskDispatcher, name='Uformer_KAv5'):
    def __init__(self, cfg=None):
        ...
        parser.add_argument('--arch', '-a', metavar='ARCH', default='Uformer_KAv5')
...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--arch', type=str, default ='Uformer_KAv5',  help='archtechture')
