...
class parser_args(TaskDispatcher, name='Restormer_SE'):
    def __init__(self, cfg=None):
        ...
        model_path = r'results\derain\Rain100L\Restormer_SE\Test\model_2023-10-02-01-21-22\500.pth.tar'
