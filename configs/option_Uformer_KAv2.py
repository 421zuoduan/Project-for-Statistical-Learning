...
class parser_args(TaskDispatcher, name='Uformer_KAv2'):
    def __init__(self, cfg=None):
        ...
        parser.add_argument('--arch', '-a', metavar='ARCH', default='Uformer_KAv2')
...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--arch', type=str, default ='Uformer_KAv2',  help='archtechture')
