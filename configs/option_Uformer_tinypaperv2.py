...
class parser_args(TaskDispatcher, name='Uformer_tinypaperv2'):
    def __init__(self, cfg=None):
        ...
        model_path = r'results\derain\Rain100L\Uformer_tinypaperv2\Test\model_2023-12-04-12-23-26\1000.pth.tar'
        ...
        parser.add_argument('--arch', '-a', metavar='ARCH', default='Uformer_tinypaperv2')
        ...
        # SRData
        parser.add_argument('--model', default='Uformer_tinypaperv2',
                            help='model name')
...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--arch', type=str, default ='Uformer_tinypaperv2',  help='archtechture')
