...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.dim = dim
        self.input_resolution = input_resolution
        self.num_heads = 1 if num_heads==1 else num_heads//2
        ...
        self.attn = WindowAttention(dim//2,
                                    ...
                                    attn_drop=attn_drop,
                                    proj_drop=drop)
        self.kernel_attn = KernelAttention(dim//2, input_resolution[0], num_heads=num_heads, ka_win_num=16, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x, x_size):
        ...
        x_windows = x_windows.view(-1, self.window_size * self.window_size,
                                   C//2)  # nW*B, window_size*window_size, C
        ...
        # concat
        x = torch.cat([x, attn_windows_ka], dim=-1)
...
if __name__ == '__main__':
    ...
    model = SwinIR(upscale=1,
                   ...
                   num_heads=[6, 6, 6, 6],
                   mlp_ratio=2,
                   upsampler='nearest+conv')  #pixelshuffledirect
    print(model)
