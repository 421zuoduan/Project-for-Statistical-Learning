...
class LeWinTransformerBlock_KA(nn.Module):
    def __init__(self, dim, input_resolution, num_heads, window_size=8, shift_size=0,
        ...
        self.kernel_attn = KernelAttention(dim//2, input_resolution, num_heads=num_heads, ka_window_size=16, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x, mask=None):
        ...
        attn_windows_ka = self.kernel_attn(x_ka).permute(0, 2, 3, 1).contiguous().view(B, L, C//2)
