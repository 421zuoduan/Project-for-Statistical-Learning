...
class derainSession():
    ...
    def get_dataloader(self, dataset_name, distributed):
        ...
        elif dataset_name in ["Rain200L", "Rain200H", "Rain100L", "Rain100H"]:
    ...
    def get_eval_dataloader(self, dataset_name, distributed):
        ...
        if dataset_name in ['Rain200H', 'Rain200L', 'Rain100L', 'Rain100H']:
        ...
        elif dataset_name == 'testreal':
            dataset = TestDatasetV2(self.args.data_dir, dataset_name + "/test_real")
